...
async function sendWelcomeEmail(email, name) {
    ...
    const text = `Hello ${name},\n\nWelcome to Infinity AI!\n\nYour account has been created successfully.\n\nYou can now securely access your workspace and start using Infinity AI.\n\nThank you for joining us.\n\nBest regards,\nInfinity AI Team`;
    const html = `
        <div style="font-family: sans-serif; padding: 20px; color: #1e293b; max-width: 500px; margin: auto; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff;">
            <div style="text-align: center; margin-bottom: 20px;">
                <span style="font-size: 32px; font-weight: bold; color: #10a37f;">∞</span>
            ...
            <p style="font-size: 14px; line-height: 1.5; color: #475569;">You can now securely access your workspace and start using Infinity AI.</p>
...
module.exports = { transporter, verifySMTP, sendOTP, sendWelcomeEmail };
